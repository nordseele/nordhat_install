...
sudo cp -f /home/we/nordhat_install/norns/files/systemd-udevd.service /lib/systemd/system/
sudo cp -f /home/we/nordhat_install/norns/files/interfaces /etc/network
